...
public class Vehicle
{
	...
	public String toString() {
		return "Vehicle [vehicleId=" + vehicleId + ", vehicleType=" + vehicleType + ", vehicleName=" + vehicleName
				+ ", vehicleModel=" + vehicleModel + ", vehicleDate=" + vehicleDate + ", vehicleCompany="
				+ vehicleCompany + ", vehicleCategory=" + vehicleCategory + ", vehicleTorque=" + vehicleTorque
				+ ", vehicleHp=" + vehicleHp + ", vehicleMaxSpeed=" + vehicleMaxSpeed + ", vehicleAcc=" + vehicleAcc
